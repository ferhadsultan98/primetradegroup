...
import { ReactComponent as NoDataIcon } from "./no-data-icon.svg"; // Assuming you have an SVG icon
      ...
      <div className="serviceDetailsContainer">
        ...
        {isLoading ? (
          ...
          <div className="noDataContainer">
            ...
            <h2 className="noDataTitle">Xidmət Tapılmadı</h2>
            <p className="noDataMessage">
              Üzr istəyirik, axtardığınız xidmət haqqında məlumat tapa bilmədik.
              Başqa xidmətlərimizi kəşf etmək üçün aşağıdakı düyməni sıxın.
            </p>
            <button
                ...
                <div className="productsContainer">
                  {filteredDetails.length > 0 ? (
                    ...
                    <div className="noDataContainer">
                      ...
                      <p className="noDataMessage">
                        Seçilmiş kateqoriyada heç bir məlumat yoxdur. Başqa kateqoriyaları yoxlayın və ya xidmətlər səhifəsinə qayıdın.
                      </p>
                      <button
                        className="noDataButton"
                        onClick={() => navigate("/services")}
