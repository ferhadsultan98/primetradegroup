// src/Pages/Services/ServiceDetails/ServiceDetails.jsx
  ...
  useEffect(() => {
    const fetchServices = async () => {
      try {
        ...
        console.log("Fetched services data:", services); // Məlumatları yoxlamaq üçün
    ...
    fetchServices();
  }, [id]); // id dəyişdikdə yenidən yükləmək üçün
                  ...
                  <div className="productInfo">
                    ...
                    <div className="additionalInfoSection">
                      ...
                      <p>
                        ...
                        {product.volume || product.material || "N/A"}
                      </p>
                      <p>
                        <strong>{t("services.origin")}:</strong>{" "}
                        {product.origin || "N/A"}
                      </p>
                      <p>
                        <strong>{t("services.safety")}:</strong>{" "}
                        {product.safety || "N/A"}
                      </p>
                      <p>
                        <strong>{t("services.release_date")}:</strong>{" "}
                        {product.releaseDate || "N/A"}
                      </p>
                      <p>
                        <strong>{t("services.hashtags")}:</strong>{" "}
                        {product.hashtags ? product.hashtags.join(" ") : "N/A"}
                      </p>
                    </div>
                  </div>
                </div>
