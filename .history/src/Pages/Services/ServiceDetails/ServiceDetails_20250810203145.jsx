...
// Child component for serviceDetailsContainer
const ServiceDetailsContainer = memo(({ service, serviceDetails, categories, selectedCategory, setSelectedCategory, navigate }) => {
  ...
  return (
    <div className="serviceDetailsContainer" key={serviceDetails.length}>
