...
const ServiceDetails = () => {
      ...
      try {
        ...
        if (snapshot.exists()) {
          ...
          const uniqueCategories = [
            "all",
            ...new Set(serviceData.products.map((product) => product.category)),
          ];
        ...
        console.error("Xidmət alınarkən xəta: ", error);
      }
    };
    fetchService();
  }, [id]);
  ...
  const filteredProducts =
    selectedCategory === "all"
      ? service.products
      : service.products.filter((product) => product.category === selectedCategory);
