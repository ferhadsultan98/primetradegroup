    ...
    <div className="whyUsContainer">
      <div className="containerWrapper">
        ...
        <section className="companyOverviewSection">
          <div className="containerWrapper">
            <h2 className="sectionTitle">Why Partner with Us</h2>
            <div className="overviewContent">
              <p className="overviewText">
                At PRIME TRADE GROUP MMC, we provide unmatched expertise in supply chain and procurement solutions. Our innovative approach, global network, and commitment to efficiency empower businesses to achieve cost savings, streamline operations, and maintain a competitive edge in their industries.
              </p>
            </div>
          </div>
        </section>
