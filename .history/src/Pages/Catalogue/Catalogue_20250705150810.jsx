        ...
        <div className="bookWrapper">
          <div className={`bookSpread ${isFlippingForward ? 'flipping-forward' : ''} ${isFlippingBackward ? 'flipping-backward' : ''}`}>
            ...
            {isFlippingForward && currentSpread + 2 < pages.length && (
              <>
                <div className="bookPage leftPage flippingPage forward" style={{ backgroundColor: pages[currentSpread + 1].color }}>
                  <div className="pageContent"></div>
                </div>
            ...
            {isFlippingBackward && currentSpread - 2 >= 0 && (
              <>
                <div className="bookPage leftPage flippingPage backward" style={{ backgroundColor: pages[currentSpread - 2].color }}>
                  <div className="pageContent"></div>
                </div>
                <div className="bookPage rightPage flippingPage backward" style={{ backgroundColor: pages[currentSpread - 1].color }}>
                  <div className="pageContent"></div>
                </div>
              </>
            )}
