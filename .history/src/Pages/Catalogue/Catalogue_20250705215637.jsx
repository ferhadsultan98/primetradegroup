          ...
          <div className={`bookSpread ${isFlipping ? `flipping-${flipDirection}` : ''}`}>
            ...
            {isFlipping && flipDirection === 'forward' && (
              <>
                <div className="bookPage rightPage flippingPage forward">
                  <div className="pageContent">{pages[currentSpread + 2]}</div>
                </div>
                <div className="bookPage leftPage flippingPage forward back">
                  <div className="pageContent">{pages[currentSpread + 1]}</div>
                </div>
              </>
            )}
            {isFlipping && flipDirection === 'backward' && (
              <>
                ...
                <div className="bookPage rightPage flippingPage backward back">
                  <div className="pageContent">{pages[currentSpread - 1]}</div>
                </div>
              </>
            )}
