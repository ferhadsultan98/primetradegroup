...
const Header = () => {
  ...
  const [selectedLanguage, setSelectedLanguage] = useState("AZ"); // Fallback to 'AZ'
  ...
  useEffect(() => {
    ...
    // Set language once i18n is initialized
    setSelectedLanguage(i18n.language ? i18n.language.toUpperCase() : "AZ");
