  ...
  return (
    <footer className="footerContainer">
      <div className="footerContent">
        ...
        <ul className="linkList">
          <li><a href="#cleaning-detergent">{t('footer.cleaningDetergent')}</a></li>
          <li><a href="#uniforms">{t('footer.uniforms')}</a></li>
          <li><a href="#it-equipment">{t('footer.itEquipment')}</a></li>
          <li><a href="#household-goods">{t('footer.householdGoods')}</a></li>
          <li><a href="#furniture">{t('footer.furniture')}</a></li>
          <li><a href="#plumbing">{t('footer.plumbing')}</a></li>
          <li><a href="#stationery">{t('footer.stationery')}</a></li>
        </ul>
      </div>
