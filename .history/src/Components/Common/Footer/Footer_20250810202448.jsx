        ...
        <div className="footerTop">
          ...
          <div className="footerSection">
            ...
            <ul className="linkList">
              ...
              <li>
                <a href="/services/cleaning">{t("footer.itEquipment")}</a>
              </li>
              <li>
                <a href="/services/cleaning">{t("footer.householdGoods")}</a>
              </li>
              <li>
                <a href="/services/cleaning">{t("footer.furniture")}</a>
              </li>
              <li>
                <a href="/services/cleaning">{t("footer.plumbing")}</a>
              </li>
              <li>
