  ...
  return (
    <div className="CTPageCoverBookCatalog">
      <div className="CTPageCoverCatalogHeader">
        <img
          className="CTPageCoverLogo"
          src={CTCoverLogo}
          alt="Şirkət Logosu"
        />
        <h1 className="CTPageCoverCatalogTitle">Xidmət Kataloqu</h1>
        <p className="CTPageCoverCatalogSubtitle">
          Keyfiyyətli xidmətlərimizlə tanış olun
        </p>
      </div>
      <div className="CTPageCoverBookContainer">
        <div className="CTPageCoverBookWrapper">
          <div className="CTPageCoverBookCover">
            <div
              className="CTPageCoverPageContent"
            ...
            >
              <div className="CTPageCoverContactInfo">
                <div className="CTPageCoverContactItem">
                  <i><FaPhone className="CTPageCoverContactIcon" /></i>
                ...
                <div className="CTPageCoverContactItem">
                  <i><FaEnvelope className="CTPageCoverContactIcon" /></i>

                  <a
                    href="https://www.sirket.az"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    info@sirket.az
                ...
                <div className="CTPageCoverContactItem">
                  <i><FaGlobe className="CTPageCoverContactIcon" /></i>
                  <a
                    href="https://www.sirket.az"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="CTPageCoverContactItem">
                  <i><FaInstagram className="CTPageCoverContactIcon" /></i>
                  <a
                    href="https://www.instagram.com/sirket"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    sirket
