  ...
  return (
    <>
      <SectionHeader
        ...
        subtitle="PRIME TRADE GROUP MMC olaraq müştərilərimizin təchizat və satınalma ehtiyaclarına operativ, etibarlı və peşəkar yanaşma ilə cavab veririk."
      />
      <div className="whyUsContainer">
        ...
        <section className="benefitsSection">
          <div className="containerWrapper">
            <h2 className="sectionTitle">Dəyər Verdiyimiz Prinsiplər</h2>
            <div className="benefitsGrid">
              <div className="benefitCard">
                <ShieldCheck className="benefitIcon" />
                <h3 className="benefitTitle">Etibarlı Tərəfdaşlıq</h3>
                <p className="benefitText">
                  Şirkətimiz həm dövlət, həm də özəl sektor üçün bir çox uğurlu
                  layihə və təchizat prosesini həyata keçirmişdir.
                  Müştərilərimizin bizə olan güvəni illərlə formalaşan
                  peşəkarlığımızın nəticəsidir.
                </p>
              </div>
              <div className="benefitCard">
                ...
                <p className="benefitText">
                  Təmizlik məhsullarından tutmuş İT avadanlıqlarına, mebeldən iş
                  geyiminə qədər bir şirkətin ehtiyac duyduğu bütün məhsulları
                  bir mərkəzdən təmin edirik.
                </p>
              </div>
              <div className="benefitCard">
                ...
                <p className="benefitText">
                  Təqdim etdiyimiz bütün məhsullar beynəlxalq və yerli keyfiyyət
                  standartlarına cavab verir. Rəsmi distribyutorlarla və
                  etibarlı istehsalçılarla əməkdaşlıq edirik.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="trustGrid">
              <div className="trustCard">
                ...
                <p className="trustText">
                  Həm dövlət, həm də özəl sektor üçün uğurlu təchizat layihələri
                  ilə etibarlı tərəfdaş kimi tanınırıq.
                </p>
              </div>
              <div className="trustCard">
              ...
              <div className="trustCard">
                ...
                <p className="trustText">
                  Bütün əməkdaşlıq və təchizat proseslərimiz şəffaf, qanuni və
